...
const Hamburger = styled.div`
    ...
    // Direct descendants of Hamburger component (each line in Hamburger)
    >div {
        height: 3px;
        width: 100%;
...
export function Header(){
    ...
    return (
        <HeaderWrapper>
            {/* The function in setMenuOpen is a shorthand for toggling between true and false for state */}
